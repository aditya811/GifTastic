$(document).ready(function() {
  ...
  var topics = ['Arrested Development','Parks And Recreation','Community','Archer', 'Better Call Saul', 'Rick And Morty', 'Game of Thrones', 'Luke Cage', 'The Sinner', 'Bojack Horseman'];
  var url = 'https://api.giphy.com/v1/gifs/search?api_key=pFM5KcffCW4WOpf9PYeURVCYvF0HXsuH&q=';
  ...
  function gifDisplay() {
    ...
    url = 'https://api.giphy.com/v1/gifs/search?api_key=pFM5KcffCW4WOpf9PYeURVCYvF0HXsuH&q=';
  }
